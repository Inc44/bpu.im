...
graph TB
	...
	subgraph Deployment[Deployment Layer]
		...
		Proxy -->|Proxies Requests| Hosting(Netcup ARM64 Server on Debian: 6 vCores, 8 GB RAM, 256 GB NVMe):::deployment
	...
	Quiz -->|Submits to| Framework
	CodeDisplay -->|Requests Execution| Framework
	Server -->|Proxies to| Framework
	Server -->|Serves| Articles

	linkStyle default background:#c7c3bd,stroke-width:0.12rem
	classDef frontend fill:#fbcdc9,stroke:#ed3524,stroke-width:0.16rem,color:black
	classDef backend fill:#ffe1af,stroke:#fa9d01,stroke-width:0.16rem,color:black
	classDef deployment fill:#c6f5da,stroke:#2eda77,stroke-width:0.16rem,color:black
	classDef execution fill:#dcf8fc,stroke:#14c7de,stroke-width:0.16rem,color:black
	classDef conversion fill:#b4d4ff,stroke:#016fff,stroke-width:0.16rem,color:black
	classDef data fill:#e3e4f4,stroke:#444fad,stroke-width:0.16rem,color:black
	classDef storage fill:#eae0f6,stroke:#8c54d0,stroke-width:0.16rem,color:black
```